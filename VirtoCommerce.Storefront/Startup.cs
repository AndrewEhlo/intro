    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IPostRenderTemplateChange, PostRenderTemplateChanger>(serviceProvider => {
                ...
                var section = Configuration.GetSection("VirtoCommerce:LiquidThemeEngine:PostRenderTemplateChange");
                return new PostRenderTemplateChanger(workContextAccessor, section);
            });
